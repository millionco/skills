...
Budge also uses React Grab primitives for manual element selection. Press `Cmd+Shift+1`, select an element, and Budge appears with editable slides for that element.
